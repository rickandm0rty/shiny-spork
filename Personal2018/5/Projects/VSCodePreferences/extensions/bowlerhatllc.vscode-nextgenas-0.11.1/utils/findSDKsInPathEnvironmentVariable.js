...
function findSDKsInPathEnvironmentVariable() {
    let result = [];
    ...
    paths.forEach((currentPath) => {
        ...
        if (fs.existsSync(mxmlcPath)) {
            for (let i = 0, count = MODULE_NAMES.length; i < count; i++) {
                ...
                let validSDK = validateFrameworkSDK_1.default(sdkPath);
                if (validSDK !== null) {
...
exports.default = findSDKsInPathEnvironmentVariable;
//# sourceMappingURL=findSDKsInPathEnvironmentVariable.js.map