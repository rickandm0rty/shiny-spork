...
class SWFDebugConfigurationProvider {
    provideDebugConfigurations(workspaceFolder, token) {
    ...
    resolveDebugConfiguration(workspaceFolder, debugConfiguration, token) {
        if (workspaceFolder === undefined) {
        ...
        let appDescriptorPath = null;
        let outputPath = null;
        let mainClassPath = null;
...
exports.default = SWFDebugConfigurationProvider;
//# sourceMappingURL=SWFDebugConfigurationProvider.js.map