 ...
 */
function validateFrameworkSDK(sdkPath) {
    if (!sdkPath) {
        return null;
    }
...
exports.default = validateFrameworkSDK;
function validatePossibleFrameworkSDK(sdkPath) {
    if (!sdkPath) {
        return false;
    }
...
//# sourceMappingURL=validateFrameworkSDK.js.map